    ...
    var imageData: Data? {
        didSet {
            ...
            guard let image = NSImage(data: imageData),
                ...
                let containerType = CGImageSourceGetType(imageSource), UTTypeConformsTo(containerType, kUTTypeGIF) else {
            ...
            for imageRepresentation in image.representations {
                guard let bitmapRepresentation = imageRepresentation as? NSBitmapImageRep,
                    let frameCount = bitmapRepresentation.value(forProperty: NSBitmapImageRep.PropertyKey.frameCount) as? Int else { continue }
