...
struct ColorConstants {
    ...
    struct BackgroundColor {
        ...
        static let popover = NSColor(named: "popover_bg_color")
    }
    ...
    struct SetupComplete {
        ...
        struct MigrationButton {
            static let arrowAndKeyboard = NSColor(named: "arrow_and_keyboard")
        ...
        struct BackupButton {
            ...
            static let clockhandsAndArrowhead = NSColor(named: "clockhands_and_arrowhead")
